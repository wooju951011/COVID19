...
class ViewController: UIViewController {
    ...
    func configureChartView(covidOverviewList: [CovidOverView]) {
        let enrties = covidOverviewList.compactMap{[weak self] overview -> PieChartDataEntry? in
        ...
        let dataSet = PieChartDataSet(entries: enrties, label: "코로나 발생 현황")
    ...
    func fetchCovidOverView(
        ...
        let param = [
            "serviceKey": "lZfpCOIvx6NXsh2oGBzyrWiu4c719HDMk"
        ]
